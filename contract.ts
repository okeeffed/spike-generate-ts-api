...
const adminUserPaymentMethodsDelete204 = z.union([
  z.object({
    reason: z.string(),
    errors: z.array(
      z.object({
...
export const contract = c.router({
  postV1AdminGlobalWallets: {
    ...
    responses: {
      201: c.type<z.infer<typeof adminCreateWalletResponse>>(),
      400: c.type<z.infer<typeof errorResponse>>(),
      401: c.type<z.infer<typeof errorResponse>>(),
      403: c.type<z.infer<typeof errorResponse>>(),
      409: c.type<z.infer<typeof errorResponse>>(),
    },
  ...
  postV1AdminIdentityUsers: {
    ...
    responses: {
      201: c.type<z.infer<typeof createUserProfileResponse>>(),
      202: c.type<void>(),
      400: c.type<z.infer<typeof errorResponse>>(),
      401: c.type<z.infer<typeof errorResponse>>(),
      403: c.type<z.infer<typeof errorResponse>>(),
  ...
  postV1IdentityMigrationsProfiles: {
    ...
    responses: {
      201: c.type<z.infer<typeof migrateUserProfileResponse>>(),
      400: c.type<z.infer<typeof docErrorResponse>>(),
      401: c.type<z.infer<typeof docErrorResponse>>(),
      403: c.type<z.infer<typeof docErrorResponse>>(),
      409: c.type<z.infer<typeof docErrorResponse>>(),
    },
  ...
  postV1IdentityMigrationsAddresses: {
    ...
    responses: {
      200: c.type<z.infer<typeof migrateUserAddressResponse>>(),
      400: c.type<z.infer<typeof docErrorResponse>>(),
      401: c.type<z.infer<typeof docErrorResponse>>(),
      403: c.type<z.infer<typeof docErrorResponse>>(),
    },
  ...
  getV1Profiles: {
    ...
    path: "/v1/profiles",
    responses: {
      200: c.type<z.infer<typeof getUserProfileResponse>>(),
      400: c.type<z.infer<typeof errorResponse>>(),
      401: c.type<z.infer<typeof errorResponse>>(),
      403: c.type<z.infer<typeof errorResponse>>(),
    },
  ...
  patchV1Profiles: {
    ...
    path: "/v1/profiles",
    responses: {
      200: c.type<z.infer<typeof updateUserProfileResponse>>(),
      400: c.type<z.infer<typeof errorResponse>>(),
      401: c.type<z.infer<typeof errorResponse>>(),
      403: c.type<z.infer<typeof errorResponse>>(),
      404: c.type<z.infer<typeof errorResponse>>(),
  ...
  getV1ProfilesAddresses: {
    ...
    responses: {
      200: c.type<z.infer<typeof listAddressesResponse>>(),
      400: c.type<z.infer<typeof errorResponse>>(),
      401: c.type<z.infer<typeof errorResponse>>(),
      403: c.type<z.infer<typeof errorResponse>>(),
    },
  ...
  postV1ProfilesAddresses: {
    ...
    path: "/v1/profiles/addresses",
    responses: {
      200: c.type<z.infer<typeof createAddressResponse>>(),
      400: c.type<z.infer<typeof errorResponse>>(),
      401: c.type<z.infer<typeof errorResponse>>(),
      403: c.type<z.infer<typeof errorResponse>>(),
    },
  ...
  putV1AdminPaymentsLoyaltyPrograms: {
    ...
    path: "/v1/admin/payments/loyalty-programs",
    responses: {
      200: c.type<z.infer<typeof adminUpdateLoyaltyProgramsResponse>>(),
      401: c.type<z.infer<typeof errorResponse>>(),
      403: c.type<z.infer<typeof errorResponse>>(),
    },
  ...
  postV1PaymentsMigrationsBankCards: {
    ...
    responses: {
      200: c.type<z.infer<typeof migratePaymentMethodResponse>>(),
      400: c.type<z.infer<typeof docErrorResponse>>(),
      401: c.type<z.infer<typeof docErrorResponse>>(),
      403: c.type<z.infer<typeof docErrorResponse>>(),
      409: c.type<z.infer<typeof docErrorResponse>>(),
  ...
  postV1PaymentsMigrationsBankCardsSettingsDefault: {
    ...
    responses: {
      200: c.type<z.infer<typeof makePaymentMethodDefaultResponse>>(),
      400: c.type<z.infer<typeof docErrorResponse>>(),
      401: c.type<z.infer<typeof docErrorResponse>>(),
      403: c.type<z.infer<typeof docErrorResponse>>(),
      409: c.type<z.infer<typeof docErrorResponse>>(),
  ...
  postV1PaymentsMigrationsOrders: {
    ...
    responses: {
      200: c.type<z.infer<typeof migrateOrderResponse>>(),
      400: c.type<z.infer<typeof docErrorResponse>>(),
      401: c.type<z.infer<typeof docErrorResponse>>(),
      403: c.type<z.infer<typeof docErrorResponse>>(),
    },
  ...
  postV1PaymentsMigrationsLoyaltyCards: {
    ...
    responses: {
      200: c.type<z.infer<typeof migrateLoyaltyCardResponse>>(),
      400: c.type<z.infer<typeof docErrorResponse>>(),
      401: c.type<z.infer<typeof docErrorResponse>>(),
      403: c.type<z.infer<typeof docErrorResponse>>(),
      404: c.type<z.infer<typeof docErrorResponse>>(),
      409: c.type<z.infer<typeof docErrorResponse>>(),
    },
  ...
  getV1PaymentMethods: {
    ...
    responses: {
      200: c.type<z.infer<typeof listPaymentMethodsResponse>>(),
      400: c.type<z.infer<typeof errorResponse>>(),
      401: c.type<z.infer<typeof errorResponse>>(),
      403: c.type<z.infer<typeof errorResponse>>(),
    },
  ...
  getV1PaymentMethodsEncryptionPublicKey: {
    ...
    responses: {
      200: c.type<z.infer<typeof getPublicKeyResponse>>(),
      400: c.type<z.infer<typeof errorResponse>>(),
      401: c.type<z.infer<typeof errorResponse>>(),
      403: c.type<z.infer<typeof errorResponse>>(),
    },
  ...
  postV1PaymentMethodsBankCards: {
    ...
    responses: {
      200: c.type<z.infer<typeof createBankCardPaymentMethodResponse>>(),
      400: c.type<z.infer<typeof errorResponse>>(),
      401: c.type<z.infer<typeof errorResponse>>(),
      403: c.type<z.infer<typeof errorResponse>>(),
    },
  ...
  postV1PaymentMethodsLoyalty: {
    ...
    responses: {
      200: c.type<z.infer<typeof createLoyaltyCardResponse>>(),
      400: c.type<z.infer<typeof errorResponse>>(),
      401: c.type<z.infer<typeof errorResponse>>(),
      403: c.type<z.infer<typeof errorResponse>>(),
      409: c.type<z.infer<typeof errorResponse>>(),
  ...
  getV1PaymentMethodsLoyalty: {
    ...
    path: "/v1/payment-methods/loyalty",
    responses: {
      200: c.type<z.infer<typeof listLoyaltyCardsResponse>>(),
      401: c.type<z.infer<typeof errorResponse>>(),
      403: c.type<z.infer<typeof errorResponse>>(),
    },
    query: z.object({
  ...
  getV1PaymentMethodsLoyaltyPrograms: {
    ...
    responses: {
      200: c.type<z.infer<typeof listLoyaltyProgramsResponse>>(),
      401: c.type<z.infer<typeof errorResponse>>(),
      403: c.type<z.infer<typeof errorResponse>>(),
    },
    summary: "",
  ...
  postV1PaymentMethodsLoyaltyFlybuysInitiateLink: {
    ...
    responses: {
      200: c.type<z.infer<typeof initiateFlybuysLinkResponse>>(),
      401: c.type<z.infer<typeof errorResponse>>(),
      403: c.type<z.infer<typeof errorResponse>>(),
      409: c.type<z.infer<typeof errorResponse>>(),
    },
  ...
  postV1PaymentMethodsLoyaltyFlybuysCompleteLink: {
    ...
    responses: {
      200: c.type<z.infer<typeof completeFlybuysLinkResponse>>(),
      400: c.type<z.infer<typeof errorResponse>>(),
      401: c.type<z.infer<typeof errorResponse>>(),
      403: c.type<z.infer<typeof errorResponse>>(),
      409: c.type<z.infer<typeof errorResponse>>(),
